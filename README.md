...
7. [Cartesian Closed Categories](sections/1_essentials/07_ccc.md) (+ Evaluation Map, Lambda Calculus)
...
4. [Locally Cartesian Closed Categories](/sections/2_intuitionistic/04_local_ccc.md) (+ Heyting Categories)