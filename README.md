...
4. [Functor Categories](sections/1_essentials_computation/04_functor_categories.md) (+ Natural Transformations)
5. [Currying and Uncurrying](sections/1_essentials_computation/05_currying_uncurrying.md) (+ Adjunctions)
6. [Diagonal Functor](sections/1_essentials_computation/06_diagonal_functor.md) (+ Limits, Colimits, Products, Coproducts)
7. [Cartesian Closed Categories](sections/1_essentials_computation/07_cartesian_closed_categories.md) (+ Evaluation Map, Lambda Calculus)
8. [Presheaves](sections/1_essentials_computation/08_presheaves.md) (+ Yoneda Embedding)
9. [Equalizers and Coequalizers](sections/1_essentials_computation/09_equalizers_coequalizers.md) (+ Pullbacks, Pushouts)
